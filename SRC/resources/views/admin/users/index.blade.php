                        ...
                        @foreach ($users as $user)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    ...
                                    <form action="{{ route('admin.users.destroy', $user) }}" method="POST" class="inline-block ml-4" onsubmit="return confirm('Bạn có chắc chắn muốn xóa người dùng \'{{ $user->name }}\'? Hành động này không thể hoàn tác.');">
        @csrf
        @method('DELETE')
